...
.DESCRIPTION
By default (no parameters), returns an array of user objects. Obejcts correspond to any users who hare currently licensed. When $LicenseName parameter is provided, returns all user objects that contain the respective license.
