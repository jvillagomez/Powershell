...
#$licOptions = New-MsolLicenseOptions -AccountSkuId ucxucr:STANDARDWOFFPACK_FACULTY -DisabledPlans EXCHANGE_S_STANDARD

#Set-MsolUserLicense -UserPrincipalName jpavelski@ucx.ucr.edu -AddLicenses ucxucr:STANDARDWOFFPACK_FACULTY -LicenseOptions $licOptions
